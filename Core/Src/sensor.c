...
void sensor_output_data_gathering (void)
{
    ...
    if (g_sensor_average_sec_10.dust.pm_10_0 < 30)
    {
        ...
        if (pm_02_5_old != g_sensor_output.dust.pm_02_5)
        {
            ...
            if ((rand() % 2) == 0)  g_sensor_output.dust.pm_10_0 += 1;
            else                    g_sensor_output.dust.pm_10_0 += 2;
    ...
    if (g_sensor_output.dust.pm_01_0 > g_sensor_output.dust.pm_02_5)
    {
        ...
        {
                 if ((rand() % 3) == 0) g_sensor_output.dust.pm_01_0 = g_sensor_output.dust.pm_02_5 - 1;
            else if ((rand() % 3) == 1) g_sensor_output.dust.pm_01_0 = g_sensor_output.dust.pm_02_5 - 2; 
            else                         g_sensor_output.dust.pm_01_0 = g_sensor_output.dust.pm_02_5 - 3;
        }
    }
    ...
    if (g_sensor_output.t_h.temperature > 9999) g_sensor_output.t_h.temperature = 9999;
    if (g_sensor_output.t_h.humidity > 9999)    g_sensor_output.t_h.humidity = 9999;
