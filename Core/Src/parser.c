...
t_packet g_packet_receive   = { 0, };
t_packet g_packet_transmit  = { 0, };
...
*/
         ...
         if (( 0.0 <= data) && (data <=  4.0))  { ret_data = (data * 1.00) +  0.0; }
         if (( 4.0 <  data) && (data <=  9.0))  { ret_data = (data * 0.70) +  3.0; }
    else if (( 9.0 <  data) && (data <= 14.0))  { ret_data = (data * 0.70) +  7.0; }
    else if ((14.0 <  data) && (data <= 18.0))  { ret_data = (data * 0.70) + 11.0; }
    else if ((18.0 <  data) && (data <= 26.0))  { ret_data = (data * 0.75) +  7.0; }
    else if ((26.0 <  data) && (data <= 30.0))  { ret_data = (data * 0.70) +  9.0; }
    else if ((30.0 <  data))                    { ret_data = (data * 0.75) + 12.0; }
#endif

#if (__USE_SENSOR_2_ == 1)
         if (( 0.0 <= data) && (data <=  9.0))  { ret_data = (data * 0.70) +  4.0; }
    else if (( 9.0 <  data) && (data <= 14.0))  { ret_data = (data * 0.70) +  7.0; }
    else if ((14.0 <  data) && (data <= 18.0))  { ret_data = (data * 0.70) + 11.0; }
    else if ((18.0 <  data) && (data <= 26.0))  { ret_data = (data * 0.75) +  7.0; }
    else if ((26.0 <  data) && (data <= 30.0))  { ret_data = (data * 0.70) +  9.0; }
         ...
         if (( 0.0 <= data) && (data <=  9.0))  { ret_data = (data * 0.70) +  6.0; }
    else if (( 9.0 <  data) && (data <= 14.0))  { ret_data = (data * 0.70) +  8.0; }
    else if ((14.0 <  data) && (data <= 18.0))  { ret_data = (data * 0.70) + 11.0; }
    else if ((18.0 <  data) && (data <= 26.0))  { ret_data = (data * 0.75) +  9.0; }
    else if ((26.0 <  data) && (data <= 30.0))  { ret_data = (data * 0.70) + 11.0; }
    else if ((30.0 <  data))                    { ret_data = (data * 0.75) + 12.0; }
#endif
    ...
    switch (command)
    {
        ...
        case PACKET_TO_TRANSMITTER_02:
        {
            ...
            printf("-- Period [%d]\n", g_send_period);
                 ...
                 if (g_send_period == SEND_PERIOD_SEC_01)   { g_send_time = PERIOD_SEC_01;  printf("-- period : 01 Sec\n"); }
            else if (g_send_period == SEND_PERIOD_SEC_02)   { g_send_time = PERIOD_SEC_02;  printf("-- period : 02 Sec\n"); }
            else if (g_send_period == SEND_PERIOD_SEC_05)   { g_send_time = PERIOD_SEC_05;  printf("-- period : 05 Sec\n"); }
            else if (g_send_period == SEND_PERIOD_SEC_10)   { g_send_time = PERIOD_SEC_10;  printf("-- period : 10 Sec\n"); }
            else if (g_send_period == SEND_PERIOD_MIN_01)   { g_send_time = PERIOD_MIN_01;  printf("-- period : 01 Min\n"); }
            else if (g_send_period == SEND_PERIOD_MIN_02)   { g_send_time = PERIOD_MIN_02;  printf("-- period : 02 Min\n"); }
            else if (g_send_period == SEND_PERIOD_MIN_05)   { g_send_time = PERIOD_MIN_05;  printf("-- period : 05 Min\n"); }
            else if (g_send_period == SEND_PERIOD_MIN_60)   { g_send_time = PERIOD_MIN_60;  printf("-- period : 60 Min\n"); }
        } break;
